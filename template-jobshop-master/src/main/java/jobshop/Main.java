...
public class Main {
    ...
    static {
        ...
        solvers.put("SPT", new SPT());
        solvers.put("LRPT", new LRPT());
        solvers.put("estSPT", new GloutonEST_SPT());
        solvers.put("estLRPT", new GloutonEST_LRPT());
        solvers.put("descent", new DescentSolver());
        solvers.put("tabou", new Solvertabou());
